## Phishing Email Investigation ✉️

Completed an end-to-end **phishing email investigation** focusing on real SOC Level 1 workflows.

### Key Highlights 💡
- Analyzed email headers (SPF, From / Reply-To / Return-Path)
- Extracted and defanged malicious URLs
- Identified social engineering techniques
- Produced a SOC-style verdict and response actions

### Framework Mapping 
- **MITRE ATT&CK:** T1566.002 – Spearphishing Link  
- **Essential Eight:** MFA, User Application Hardening  
- **NIST CSF 2.0:** Detect → Respond → Recover

This project strengthened my **practical SOC L1 skills** in email triage, evidence-based decision-making, and professional reporting.
